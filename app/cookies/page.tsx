...
const cookieGroups = [
  ...
  },
  {
    ...
    body: "Umožňují měřit výkon reklamních kampaní a zobrazovat relevantní reklamy na platformách Meta. Nasazujeme je jen s Vaším souhlasem.",
    items: ["[DOPLNIT: Meta Pixel po nasazení]"],
  },
];
